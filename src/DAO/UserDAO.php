...
class UserDAO extends DAO implements UserProviderInterface
{
    ...
    public function findAll() {
        $sql = "SELECT * FROM user ORDER BY usr_role, usr_pseudo";
    ...
    {
        $sql = "SELECT * FROM user WHERE usr_pseudo=?";
    ...
    {
        return 'ProjetPHP\Domain\User' === $class;
    }
    ...
    protected function buildDomainObject(array $row) {
        ...
        $user->setUsername($row['usr_pseudo']);
